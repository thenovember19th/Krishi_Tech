disease_dic = {
    'Apple___Apple_scab': """ <b>Crop</b>: Apple <br/>Disease: Apple Scab<br/>
        ...
        <br/><br/> 1. Fungal Infection: Apple scab is caused by the fungus Venturia inaequalis, which infects leaves, fruits, and twigs, leading to dark, scabby lesions.

        <br/> 2. Environmental Conditions: Warm, humid weather and rain facilitate the spread of spores, especially during spring and early summer.

        <br/><br/> How to prevent/cure the disease <br/>
        <br/>1. Pruning and Sanitation: Remove and destroy infected leaves and fruits to reduce the fungal spore load.
        
        <br/>2. Fungicide Application: Apply fungicides preventively before symptoms appear, especially during periods of prolonged moisture and humidity. Rotate fungicides with different modes of action to prevent resistance buildup.""",

    'Apple___Black_rot': """ <b>Crop</b>: Apple <br/>Disease: Black Rot<br/>
        <br/> Cause of disease:

        <br/><br/>1. Fungal Infection: Black rot in apples is caused by the fungus Botryosphaeria obtusa, which infects fruits, leaves, and twigs, causing dark, sunken lesions with concentric rings.

        <br/>2. Environmental Conditions: Warm, humid weather during fruit ripening promotes the spread of spores, and rain helps disseminate them.

        <br/><br/> How to prevent/cure the disease <br/>
        <br/>1. Sanitation: Remove and destroy infected fruits and leaves to reduce fungal spore sources.

        <br/>2. Fungicide Treatment: Apply fungicides preventively starting before flowering and continue throughout the growing season, especially during rainy periods. Rotate fungicides with different modes of action to prevent resistance.""",
    ...
    'Apple___Cedar_apple_rust': """ <b>Crop</b>: Apple <br/>Disease: Cedar Apple Rust<br/>
        ...
        <br/>2. Environmental Conditions: Wet weather in spring and early summer is crucial for the development and spread of cedar apple rust spores between the two hosts.
        ...
        <br/>2. The best way to do this is to prune the branches about 4-6 inches below the galls.""",
    ...
    'Cherry_(including_sour)___Powdery_mildew': """ <b>Crop</b>: Cherry <br/>Disease: Powdery Mildew<br/>
        ...
        <br/>1. Podosphaera clandestina, a fungus that most commonly infects young, expanding leaves but can also be found on buds, fruit and fruit stems. It overwinters as small, round, black bodies (chasmothecia) on dead leaves, on the orchard floor, or in tree crotches. Colonies produce more (asexual) spores generally around shuck fall and continue the disease cycle.

        <br/>2. Environmental Conditions: Warm days and cool nights with high humidity create ideal conditions for powdery mildew spores to germinate and spread.


        <br/><br/> How to prevent/cure the disease <br/>

        <br/>1. Keep irrigation water off developing fruit and leaves by using irrigation that does not wet the leaves. Also, keep irrigation sets as short as possible.
        
        <br/>2. Follow cultural practices that promote good air circulation, such as pruning, and moderate shoot growth through judicious nitrogen management.""",
    ...
    'Strawberry___Leaf_scorch': """ <b>Crop</b>: Strawberry <br/>Disease: Leaf Scorch<br/>
        ...
        <br/><br/> 1. Fungal Infection: Leaf scorch in strawberries is primarily caused by the fungus Diplocarpon earlianum. This pathogen thrives in warm, humid conditions and infects the leaves, causing dark, irregular spots that eventually coalesce and lead to leaf death.

        <br/> 2. Environmental Conditions: Prolonged wetness and high humidity create an ideal environment for the fungal spores to germinate and spread. Poor air circulation and densely planted crops can exacerbate the problem, promoting the rapid spread of the disease.

        <br/><br/> How to prevent/cure the disease <br/>
        <br/>1. Improve Air Circulation: Ensure proper spacing between plants and prune excess foliage to enhance airflow, reducing the humidity levels that favor fungal growth.

        <br/>2. Fungicide Application: Regularly apply appropriate fungicides as a preventive measure, especially during periods of high humidity and wet conditions to control and prevent the spread of the fungus.""",
